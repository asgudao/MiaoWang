...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "page-wrap" }), [
    _cE("view", _uM({ class: "profile-header" }), [
      ...
      _cE("view", _uM({ class: "profile-info" }), [
        ...
        _cE("view", _uM({
          ...
          _cE("text", _uM({
            style: _nS(_uM({ color: unref(user).memberType === 2 ? '#333' : '#FFF', fontSize: '22rpx', fontWeight: '600' }))
          }), _tD(unref(user).memberType === 2 ? 'VIP' : 'Free'), 5 /* TEXT, STYLE */)
        ], 4 /* STYLE */)
      ])
    ]),
    _cE("view", _uM({
      ...
      _cE("view", _uM({ class: "member-card-left" }), [
        _cE("text", _uM({ class: "member-card-icon" }), "⭐"),
        _cE("view", _uM({ class: "member-card-text" }), [
          _cE("text", _uM({ class: "member-card-title" }), "会员中心"),
          _cE("text", _uM({ class: "member-card-desc" }), "升级解锁更多萌宠")
        ])
      ]),
      _cE("text", _uM({ class: "member-card-action" }), "升级")
    ]),
    _cE("view", _uM({ class: "menu-list" }), [
      _cE("view", _uM({
        ...
        _cE("text", _uM({ class: "menu-text" }), "我的萌宠"),
      ...
      _cE("view", _uM({
        ...
        _cE("text", _uM({ class: "menu-text" }), "护理日历"),
        _cE("text", _uM({ class: "arrow" }), ">")
      ]),
      _cE("view", _uM({
        class: "menu-item",
        ...
        _cE("text", _uM({ class: "menu-text" }), "收藏"),
        _cE("text", _uM({ class: "arrow" }), ">")
      ]),
      _cE("view", _uM({
