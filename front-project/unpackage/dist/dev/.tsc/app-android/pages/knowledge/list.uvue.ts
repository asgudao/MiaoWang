type KI = { __$originalPosition?: UTSSourceMapPosition<"KI", "pages/knowledge/list.uvue", 23, 6>; id: number; title: string; viewCount: number }
type CT = { __$originalPosition?: UTSSourceMapPosition<"CT", "pages/knowledge/list.uvue", 24, 6>; id: number; name: string }
...
function doRequest(url: string, onOk: (data: UTSJSONObject) => void): void {
	...
	const h = new UTSJSONObject(new UTSSourceMapPosition("h", "pages/knowledge/list.uvue", 38, 8))
